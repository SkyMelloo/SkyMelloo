...
public class SkyMellooConfig {
	...
	// Everything below was drastically simplified (2026-07-27) from a fully customizable ESP system (name
	...
	// espNamedColor/espFriendlyMobsEnabled/espFriendlyColor (general mob ESP), espSelfColor,
	...
	@AutoGen(category = "esp", group = "players")
	@TickBox
	@SerialEntry(comment = "A party member's ESP (both the glow outline and the nametag marker) blinks bright red once their HP drops under 25% - an urgent \"someone needs help\" signal readable at a glance during a fight.")
	...
	@SerialEntry(comment = "Makes other invisible players (e.g. from an Invisibility Potion) render normally instead of staying hidden. Not an ESP effect - they're still blocked by walls/line-of-sight like anyone else, just no longer artificially hidden.")
